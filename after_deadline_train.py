...
trainer = pl.Trainer(max_epochs=4, log_every_n_steps=400, reload_dataloaders_every_n_epochs=1,
                     default_root_dir='exp/models/conformer_v1.after',
...
print("Train")
trainer.fit(pl_module, train_dataloader, val_dataloader, ckpt_path="./exp/models/conformer_v1/lightning_logs/version_50503577/checkpoints/last.ckpt")
